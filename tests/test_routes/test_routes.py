...
class TestRoutes(unittest.TestCase):
    ...
    def test_route_get_call(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_get_call_no_version(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_get_status_call(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_get_status_call_no_version(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_post_call(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_post_call_no_version(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_put_call(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
    ...
    def test_route_put_call_no_version(self, mock_hello, mock_handler_put, mock_handler_post, mock_handler_get):
